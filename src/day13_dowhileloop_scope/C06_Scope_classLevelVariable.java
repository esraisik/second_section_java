...
public class C06_Scope_classLevelVariable {
    /*
       1- Class level'da olusturulan variable'ların scope'u tum class'tır.
           yani tüm class'tan kullanılabilirler

        2- Class level'da olusturulan variable'lar için java 2 alternatif sunar
           - static Variable : deklerasyonunda static keyword kullanılan variable'lar
           - instance Variable : deklerasyonunda static keyword kullanılmayan variable'lar
        3- ANNCAAKK class level Variable'ların kullanım seklinde static keyword'u de etkilidir.
