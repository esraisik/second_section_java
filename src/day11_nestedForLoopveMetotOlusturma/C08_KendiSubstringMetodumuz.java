...
public class C08_KendiSubstringMetodumuz {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(str.substring(basIndex, bitIndex));  // yukarıdaki kodla aynı işi yapıyor aöa daha kısa ve anlaşilir
        // metot olusturmanın faydalarından biri
