...
public class C13_MetotCalistirma {
    ...
    public static void main(String[] args) {
        ...
        C09_MethotOlusturmaveKullanma.notOrtalamasiYazdir(67.9, 87.3);
        // Verilen notlarin ortalamasi : 77.6

        C09_MethotOlusturmaveKullanma.notOrtalamasiYazdir(47.19, 57.43);
